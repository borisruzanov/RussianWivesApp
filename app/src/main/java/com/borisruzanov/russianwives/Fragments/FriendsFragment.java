...
import com.borisruzanov.russianwives.ChatActivity;
import com.borisruzanov.russianwives.Models.Friends;
import com.borisruzanov.russianwives.ProfileActivity;
...
public class FriendsFragment extends Fragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       ...
       //Firebase
        ...
        friendsRecyclerViewAdapter = new FirebaseRecyclerAdapter
                <Friends, FriendsViewHolder>(options) {
            @Override
                            ...
                            public void onClick(View v) {
                                ...
                                builder.setItems(options, new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int i) {
                                        ...
                                        //TODO Creating options on each item in the list -> Add real options
                                        if (i==0){
...
//                String s = friends.getName().toString();
//                Log.v("=====> ", " " + s);
//                friendsViewHolder.setName(userName);
