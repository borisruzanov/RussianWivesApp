...
public class ChatMessageActivity extends MvpAppCompatActivity implements ChatMessageView {
    ...
    public ChatMessagePresenter provideChatMessagePresenter() {
        return presenter;
                //new ChatMessagePresenter(new ChatMessageInteractor(new ChatMessageRepository()));
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new ChatMessageAdapter(getIntent().getStringExtra("photo_url"), getIntent().getStringExtra("nameText"));
